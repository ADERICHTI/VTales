...
function showStory(storyTitle) {
  ...
  if (currentStory.chapters.length > 0) {
    ...
    latestChapterInfo.innerHTML = `
      <div class="chapter-card paper-layer" style="background: linear-gradient(to top, #aaaaaa20, #aaaaaa40), url('${latestChapter.imageUrl || currentStory.imageUrl}'); background-size: cover; background-repeat: no-repeat;">
